Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/Hummer/3.1.5/Hummer.zip" }
  s.requires_arc = true
  ...
  s.subspec 'Hmr' do |sh|
    ...
    sh.dependency 'Protobuf', '>= 3.0.0'
sh.dependency 'ZipArchive', '>= 1.0.0'
sh.dependency 'deviceinfokit', '~> 1.1.4'
sh.dependency 'hdstatsdk', '>= 3.2.0'
sh.dependency 'spidercrab', '~> 1.2.2'
sh.dependency 'yyservicesdk', '~> 3.3.3'
  end
  s.subspec 'Hmr_macOS' do |sh_macOS|
    ...
    sh_macOS.dependency 'Protobuf', '>= 3.0.0'
sh_macOS.dependency 'ZipArchive', '>= 1.0.0'
sh_macOS.dependency 'deviceinfokit/deviceinfokitmacOS', '~> 1.1.4'
sh_macOS.dependency 'spidercrab/spidercrab_macOS', '~> 1.2.2'
sh_macOS.dependency 'yyservicesdk/yyservicesdkmaclib', '~> 3.3.3'
  end
