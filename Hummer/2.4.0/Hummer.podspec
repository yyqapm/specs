Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.4.0/Hummer.zip" }
	s.platform     = :ios, '8.0'
...
sc.dependency 'gslbsdki', '>= 1.3.2'
sc.dependency 'hdstatsdk/HiidoSDKDynamic', '>= 3.2.0'
sc.dependency 'yylogger', '>= 1.0.0'
sc.dependency 'yyservicesdk', '>= 2.2.1'
  	end
