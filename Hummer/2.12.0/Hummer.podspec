Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.12.0/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'hydra', '1.2.0'
sc.dependency 'jolog/jolog-full', '1.1.8'
sc.dependency 'protobuf', '3112.6726.0'
  end
...
sc_nc.dependency 'hydra/lite', '1.2.0'
sc_nc.dependency 'jolog/jolog-lite', '1.1.8'
sc_nc.dependency 'protobuf', '3112.6726.0'
  end
  ...
  s.subspec 'Core_macOS' do |sc_macOS|
    ...
    sc_macOS.dependency 'protobuf', '3112.6726.0'
  end
