Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.18/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'spidercrab', '~> 1.0.1'
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '~> 2.5.1'
  end
  ...
  s.subspec 'Rtm_macOS' do |srtm_macOS|
    ...
    srtm_macOS.dependency 'Hummer/Core_macOS'
