Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.16-dev.3/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '~> 2.3.9'
  end
