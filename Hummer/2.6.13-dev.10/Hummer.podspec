Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.13-dev.10/Hummer.zip" }
	s.platform     = :ios, '8.0'
...
sc.dependency 'yylogger', '1.0.8'
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '~> 2.3.3'
  	end
  	...
  	s.subspec 'Channel' do |scl|
  		scl.vendored_frameworks 	    = 'libs/HMRChannel.framework'
