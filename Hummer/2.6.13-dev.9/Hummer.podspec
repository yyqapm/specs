Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.13-dev.9/Hummer.zip" }
	s.platform     = :ios, '8.0'
...
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '~> 2.3.1'
  	end
