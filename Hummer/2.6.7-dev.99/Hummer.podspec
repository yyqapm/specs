Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.7-dev.99/Hummer.zip" }
	s.platform     = :ios, '8.0'
...
sc.dependency 'yylogger', '>= 1.0.5'
sc.dependency 'yyservicesdk', '~> 2.2.16'
  	end
