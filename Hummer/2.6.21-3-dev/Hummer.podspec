Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.21-3-dev/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '2.6.0-dev.1'
  end
