Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.11.0/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'deviceinfokit', '~> 1.1.4'
sc.dependency 'hdstatsdk', '>= 3.2.0'
sc.dependency 'spidercrab', '~> 1.2.2'
sc.dependency 'yyservicesdk', '~> 3.3.3'
  end
...
sc_macOS.dependency 'Protobuf', '>= 3.0.0'
sc_macOS.dependency 'ZipArchive', '>= 1.0.0'
sc_macOS.dependency 'deviceinfokit/deviceinfokitmacOS', '~> 1.1.4'
sc_macOS.dependency 'spidercrab/spidercrab_macOS', '~> 1.2.2'
sc_macOS.dependency 'yyservicesdk/yyservicesdkmaclib', '~> 3.3.3'
  end
  ...
  s.subspec 'Database_macOS' do |sd_macOS|
    ...
    sd_macOS.dependency 'FMDB', '>= 2.4.0'
  end
