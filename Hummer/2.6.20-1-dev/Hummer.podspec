Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.20-1-dev/Hummer.zip" }
  s.requires_arc = true
...
sc.dependency 'spidercrab', '100.2.1-1-dev'
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '2.5.2-dev.0'
  end
