Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/Hummer/2.6.11-dev.1/Hummer.zip" }
	s.platform     = :ios, '8.0'
...
sc.dependency 'yylogger', '1.0.6-dev.1'
sc.dependency 'yyservicesdk', '2.2.21-dev.1'
  	end
