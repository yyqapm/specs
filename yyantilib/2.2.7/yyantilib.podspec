Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyantilib/2.2.7/yyantilib.zip"}
	...
	s.subspec 'yyantilibgnu' do |ss|
        ...
        ss.frameworks = 'CoreTelephony', 'DeviceCheck'
    ...
    s.subspec 'yyantilibstd' do |sx|
	    ...
	    sx.frameworks = 'CoreTelephony', 'DeviceCheck'
