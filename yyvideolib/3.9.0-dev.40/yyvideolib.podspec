Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://repo.yypm.com/dwbuild/mobile/ios/yyvideolib/yyvideolib-ios_7.17_feature/20190520-1487-r4b545cb1a6988f3b0b7d9bd09d45aae29d4180f6//yyvideolib.zip" }
	s.platform     = :ios, '4.3'
