Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/spidercrab/100.2.1-1-dev/spidercrab.zip" }
  s.requires_arc = true
...
sc.dependency 'yyservicesdk/yyservicesdk-dynamic', '>= 2.2.22'
  end
