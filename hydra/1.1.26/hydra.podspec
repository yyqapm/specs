Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.1.26/hydra.zip" }
  s.requires_arc = true
...
sc_macOS.dependency 'jodns/jodns-mac', '1.0.6'
...
sl_macOS.dependency 'jodns/jodns-mac', '1.0.6'
  end
end
