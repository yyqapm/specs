Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.1.1/hydra.zip" }
  s.requires_arc = true
...
sc_macOS.dependency 'gslbmac', '~> 1.0.0'
...
sl_macOS.dependency 'gslbmac', '~> 1.0.0'
  end
end
