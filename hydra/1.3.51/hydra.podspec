Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/hydra/1.3.51/hydra.zip" }
  s.requires_arc = true
...
sc.dependency 'jobase/jobase', '1.3.53'
...
sl.dependency 'jobase/jobase', '1.3.53'
  end
...
sc_macOS.dependency 'jobase/jobase-mac', '1.3.53'
...
sl_macOS.dependency 'jobase/jobase-mac', '1.3.53'
  end
end
