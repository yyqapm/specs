Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.1.23-201-dev/hydra.zip" }
  s.requires_arc = true
...
sc.dependency 'jodns', '1.0.6-52-dev'
...
sl.dependency 'jodns', '1.0.6-52-dev'
  end
...
sc_macOS.dependency 'jodns/jodns-mac', '1.0.6-52-dev'
...
sl_macOS.dependency 'jodns/jodns-mac', '1.0.6-52-dev'
  end
end
