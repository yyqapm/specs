Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.1.20/hydra.zip" }
  s.requires_arc = true
...
sc.dependency 'jobase', '1.0.1'
sc.dependency 'jodns', '1.0.0'
...
sl.dependency 'jobase', '1.0.1'
sl.dependency 'jodns', '1.0.0'
  end
...
sc_macOS.dependency 'jobase/jobase-mac', '1.0.1'
sc_macOS.dependency 'jodns/jodns-mac', '1.0.0'
...
sl_macOS.dependency 'jobase/jobase-mac', '1.0.1'
sl_macOS.dependency 'jodns/jodns-mac', '1.0.0'
  end
end
