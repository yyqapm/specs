Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.1.24/hydra.zip" }
  s.requires_arc = true
...
sc.dependency 'jobase/jobase', '1.1.0'
...
sl.dependency 'jobase/jobase', '1.1.0'
  end
...
sc_macOS.dependency 'jobase/jobase-mac', '1.1.0'
...
sl_macOS.dependency 'jobase/jobase-mac', '1.1.0'
  end
end
