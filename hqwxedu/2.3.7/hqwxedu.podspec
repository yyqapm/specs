Pod::Spec.new do |s|
	...
	s.source 		= {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/hqwxedu/2.3.7/hqwxedu.zip"}
...
s.dependency 'hqimsdk', '~> 1.6.2'
s.dependency 'hqwxbase', '1.0.7'
s.dependency 'hqwxclassing', '~>1.2.5'
s.dependency 'hqwxclassroom', '~> 1.1.0'
s.dependency 'hqwxinteractive', '~> 1.3.1'
