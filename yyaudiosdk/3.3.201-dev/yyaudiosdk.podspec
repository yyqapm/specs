Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.3.201-dev/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.1.101-dev'
ss.dependency 'yyaudiodsp', '1.0.1-dev'
...
ssai.dependency 'yyaudiodsp', '1.0.1-dev'
...
ss_bd.dependency 'yyaudiodsp', '1.0.1-dev'
