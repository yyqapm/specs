Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.3.200-dev/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.1.101-dev'
ss.dependency 'yyaudiodsp', '1.0.0-14-dev'
...
ssai.dependency 'yyaudiocodec', '1.1.101-dev'
ssai.dependency 'yyaudiodsp', '1.0.0-14-dev'
	...
	s.subspec 'yyaudiosdk_bd' do |ss_bd|
		ss_bd.dependency 'yyaudiocodec/yyaudiocodec_bd', '1.1.101-dev'
ss_bd.dependency 'yyaudiodsp', '1.0.0-14-dev'
