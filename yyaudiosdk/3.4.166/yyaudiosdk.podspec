Pod::Spec.new do |s|
	...
	s.source       = {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/yyaudiosdk/3.4.166/yyaudiosdk.zip"}
	
	s.ios.deployment_target = '8.0'
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.1.13'
ss.dependency 'yyaudiodsp', '1.0.3'
    ...
    s.subspec 'yyaudiosdk_ai' do |ssai|
		ssai.dependency 'audiodenoise/audiodenoise-iOS', '4.0.0'
ssai.dependency 'yyaudiocodec', '1.1.13'
ssai.dependency 'yyaudiodsp', '1.0.3'
