Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.14/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '2.4.15'
...
audio.dependency 'transengine/transengine-audio', '2.4.15'
