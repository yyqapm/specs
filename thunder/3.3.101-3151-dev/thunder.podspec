Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.101-3151-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.41-273-dev'
full.dependency 'jobase/jobase', '1.3.2'
full.dependency 'libyuv', '1.0.3-dev.35'
full.dependency 'transengine/transengine-full', '3.3.101-1234-dev'
...
full_static.dependency 'transengine/transengine-full', '3.3.101-1234-dev'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.41-273-dev'
baidu_static.dependency 'jobase/jobase', '1.3.2'
baidu_static.dependency 'transengine/transengine-full', '3.3.101-1234-dev'
...
fullai.dependency 'hydra/lite', '1.3.41-273-dev'
fullai.dependency 'jobase/jobase', '1.3.2'
fullai.dependency 'libyuv', '1.0.3-dev.35'
fullai.dependency 'transengine/transengine-full', '3.3.101-1234-dev'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.41-273-dev'
audio.dependency 'jobase/jobase', '1.3.2'
audio.dependency 'transengine/transengine-audio', '3.3.101-1234-dev'
audio.dependency 'yyaudiosdk', '3.3.200-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.41-273-dev'
audioai.dependency 'jobase/jobase', '1.3.2'
audioai.dependency 'transengine/transengine-audio', '3.3.101-1234-dev'
