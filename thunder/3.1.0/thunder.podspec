Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.1.0/thunder.zip" }

  s.default_subspec = 'thunderbolt'
  s.subspec 'thunderbolt' do |full|
    full.platform = :ios, '4.3'
    full.ios.deployment_target = '4.3'
    full.dependency 'audioenginesdk', '10.17.1'
full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.3'
full.dependency 'hydra/lite', '1.1.24'
full.dependency 'jobase/jobase', '1.1.0'
full.dependency 'jolog/jolog-lite', '1.1.6'
full.dependency 'libvpx', '1.0.3'
full.dependency 'libyuv', '1.0.2'
full.dependency 'transengine/transengine-full', '3.1.0'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.9.0'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'audioenginesdk', '10.17.1'
audio.dependency 'hydra/lite', '1.1.24'
audio.dependency 'jobase/jobase', '1.1.0'
audio.dependency 'jolog/jolog-lite', '1.1.6'
audio.dependency 'transengine/transengine-audio', '3.1.0'
