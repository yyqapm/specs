Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.13/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.101'
...
full.dependency 'transengine/transengine-full', '2.4.13'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.10'
...
audio.dependency 'audioenginesdk', '10.9.101'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.13'
