Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.8.6/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.13.4'
...
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.6.3'
...
audio.dependency 'audioenginesdk', '10.13.4'
