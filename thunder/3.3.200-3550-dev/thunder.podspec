Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.200-3550-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.40-361-dev'
full.dependency 'jobase/jobase', '1.3.30-221-dev'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.200-1410-dev'
...
full_static.dependency 'transengine/transengine-full', '3.3.200-1410-dev'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.8-dev.6'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.40-361-dev'
baidu_static.dependency 'jobase/jobase', '1.3.30-221-dev'
...
fullai.dependency 'hydra/lite', '1.3.40-361-dev'
fullai.dependency 'jobase/jobase', '1.3.30-221-dev'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.200-1410-dev'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.8-dev.6'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.40-361-dev'
audio.dependency 'jobase/jobase', '1.3.30-221-dev'
audio.dependency 'transengine/transengine-audio', '3.3.200-1410-dev'
audio.dependency 'yyaudiosdk', '3.3.200-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.40-361-dev'
audioai.dependency 'jobase/jobase', '1.3.30-221-dev'
audioai.dependency 'transengine/transengine-audio', '3.3.200-1410-dev'
