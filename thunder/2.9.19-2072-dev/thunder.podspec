Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.9.19-2072-dev/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.15.202-dev.2'
...
full.dependency 'transengine/transengine-full', '2.9.19-868-dev'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.7.101-dev.1'
...
audio.dependency 'audioenginesdk', '10.15.202-dev.2'
audio.dependency 'gslb', '1.0.15'
audio.dependency 'hydra/lite', '1.1.5'
audio.dependency 'jolog/jolog-lite', '1.0.4'
audio.dependency 'transengine/transengine-audio', '2.9.19-868-dev'
