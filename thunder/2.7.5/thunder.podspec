Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.7.5/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.12.7'
...
audio.dependency 'audioenginesdk', '10.12.7'
