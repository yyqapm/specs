Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.101-3325-dev/thunder.zip" }

  s.default_subspec = 'thunderbolt'
  s.subspec 'thunderbolt' do |full|
    full.platform = :ios, '4.3'
    full.ios.deployment_target = '4.3'
    full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.4'
full.dependency 'hydra/lite', '1.3.46'
full.dependency 'jobase/jobase', '1.3.20'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.102'
full.dependency 'yyaudiosdk', '3.3.202-163-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.102'
  ...
  s.subspec 'thunderbolt_static' do |full_static|
    ...
    full_static.dependency 'ffmpeg/ffmpeg-small-ios', '1.0.4'
full_static.dependency 'libyuv', '1.0.5'
full_static.dependency 'transengine/transengine-full', '3.3.102'
full_static.dependency 'yyaudiosdk', '3.3.202-163-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.11.102'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.46'
baidu_static.dependency 'jobase/jobase', '1.3.20'
baidu_static.dependency 'transengine/transengine-full', '3.3.102'
baidu_static.dependency 'yy264', '1.0.17'
baidu_static.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.3.202-163-dev'
baidu_static.dependency 'yydec265', '1.0.17'
baidu_static.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.11.102'
  ...
  s.subspec 'thunderbolt_ai' do |fullai|
    ...
    fullai.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.4'
fullai.dependency 'hydra/lite', '1.3.46'
fullai.dependency 'jobase/jobase', '1.3.20'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.102'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.202-163-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.102'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.46'
audio.dependency 'jobase/jobase', '1.3.20'
audio.dependency 'transengine/transengine-audio', '3.3.102'
audio.dependency 'yyaudiosdk', '3.3.202-163-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.46'
audioai.dependency 'jobase/jobase', '1.3.20'
audioai.dependency 'transengine/transengine-audio', '3.3.102'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.202-163-dev'
