Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.21/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.201'
...
full.dependency 'transengine/transengine-full', '2.4.22'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.0'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.20'
...
audio.dependency 'audioenginesdk', '10.9.201'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.22'
