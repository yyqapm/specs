Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.7.0-777-dev/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.12.0-dev.3'
...
full.dependency 'spidercrab', '~> 1.1.0'
full.dependency 'transengine/transengine-full', '2.7.0-426-dev'
full.dependency 'yyservicesdk/yyservicesdk', '3.2.0-dev.4'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.5.0-dev.32'
...
audio.dependency 'audioenginesdk', '10.12.0-dev.3'
audio.dependency 'gslb', '1.0.10'
audio.dependency 'spidercrab', '~> 1.1.0'
audio.dependency 'transengine/transengine-audio', '2.7.0-426-dev'
