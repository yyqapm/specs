Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.8.1/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.13.1'
...
audio.dependency 'audioenginesdk', '10.13.1'
