Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.22/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.202'
...
full.dependency 'transengine/transengine-full', '2.4.23'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.0'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.21'
...
audio.dependency 'audioenginesdk', '10.9.202'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.23'
