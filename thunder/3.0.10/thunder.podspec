Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.0.10/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.16.102'
full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.1'
full.dependency 'gslb', '1.0.15'
full.dependency 'hydra/lite', '1.1.7'
full.dependency 'ittiamhevc', '0500.6803.0'
full.dependency 'jobase/jobase', '1.0.1'
full.dependency 'jolog/jolog-lite', '1.1.2'
full.dependency 'libvpx', '1.0.0'
full.dependency 'libyuv', '1194.5004.0'
full.dependency 'transengine/transengine-full', '3.0.10'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.8.10'
...
audio.dependency 'audioenginesdk', '10.16.102'
audio.dependency 'gslb', '1.0.15'
audio.dependency 'hydra/lite', '1.1.7'
audio.dependency 'jobase/jobase', '1.0.1'
audio.dependency 'jolog/jolog-lite', '1.1.2'
audio.dependency 'transengine/transengine-audio', '3.0.10'
