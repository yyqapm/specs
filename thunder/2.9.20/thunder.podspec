Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.9.20/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.15.204'
...
full.dependency 'transengine/transengine-full', '2.9.20'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.7.102'
