Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.5.7/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.10.6'
...
audio.dependency 'audioenginesdk', '10.10.6'
