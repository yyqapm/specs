Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.9.16/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.15.200'
...
full.dependency 'scloggersdk', '1.0.5'
full.dependency 'transengine/transengine-full', '2.9.13'
...
audio.dependency 'audioenginesdk', '10.15.200'
audio.dependency 'gslb', '1.0.12'
audio.dependency 'hydra/lite', '1.1.1'
audio.dependency 'scloggersdk', '1.0.5'
audio.dependency 'transengine/transengine-audio', '2.9.13'
