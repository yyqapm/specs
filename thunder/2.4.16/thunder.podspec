Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.16/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '2.4.18'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.12'
...
audio.dependency 'transengine/transengine-audio', '2.4.18'
