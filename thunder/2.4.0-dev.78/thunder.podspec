Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.0-dev.78/thunder.zip" }
	
	s.default_subspec = 'thunderbolt'
	s.subspec 'thunderbolt' do |full|
		full.platform = :ios, '4.3'
		full.ios.deployment_target = '4.3'
		full.dependency 'argo', '3.0.0-dev7'
full.dependency 'audioenginesdk', '10.9.0-dev.8'
...
full.dependency 'transengine/transengine-full', '2.4.0-dev.153'
full.dependency 'yyservicesdk/yyservicesdk', '2.3.0-dev.10'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.0-dev.11'
	...
	s.subspec 'thunder' do |audio|
		...
		audio.dependency 'argo', '3.0.0-dev7'
audio.dependency 'audioenginesdk', '10.9.0-dev.8'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.0-dev.153'
	...
	s.subspec 'thunderboltdynamic' do |dyfull|
		...
		dyfull.dependency 'ffmpeg/ffmpeg-332-ios', '332.500.003'
