Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.101-3324-dev/thunder.zip" }
...
full.dependency 'yyaudiosdk', '3.3.202-dev'
...
full_static.dependency 'yyaudiosdk', '3.3.202-dev'
...
baidu_static.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.3.202-dev'
...
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.202-dev'
...
audio.dependency 'yyaudiosdk', '3.3.202-dev'
...
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.202-dev'
