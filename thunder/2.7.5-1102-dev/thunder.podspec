Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.7.5-1102-dev/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.12.7-dev.1'
...
full.dependency 'transengine/transengine-full', '2.7.7'
full.dependency 'yyservicesdk/yyservicesdk', '~> 3.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.5.3'
...
audio.dependency 'audioenginesdk', '10.12.7-dev.1'
audio.dependency 'gslb', '1.0.12'
audio.dependency 'spidercrab', '~> 1.2.0'
audio.dependency 'transengine/transengine-audio', '2.7.7'
