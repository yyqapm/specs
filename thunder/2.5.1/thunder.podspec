Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.5.1/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.10.1'
...
full.dependency 'transengine/transengine-full', '2.5.0'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.0'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.3.1'
...
audio.dependency 'audioenginesdk', '10.10.1'
audio.dependency 'gslb', '1.0.8'
audio.dependency 'transengine/transengine-audio', '2.5.0'
