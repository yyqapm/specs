Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.101-3240-dev/thunder.zip" }

  s.default_subspec = 'thunderbolt'
  s.subspec 'thunderbolt' do |full|
    full.platform = :ios, '4.3'
    full.ios.deployment_target = '4.3'
    full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.3-dev.93'
full.dependency 'hydra/lite', '1.3.46-300-dev'
full.dependency 'jobase/jobase', '1.3.20-165-dev'
full.dependency 'libyuv', '1.0.3-dev.38'
full.dependency 'transengine/transengine-full', '3.3.101-1277-dev'
full.dependency 'yyaudiosdk', '3.3.201-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunderbolt_static' do |full_static|
    ...
    full_static.dependency 'ffmpeg/ffmpeg-small-ios', '1.0.3-dev.93'
full_static.dependency 'libyuv', '1.0.3-dev.38'
full_static.dependency 'transengine/transengine-full', '3.3.101-1277-dev'
full_static.dependency 'yyaudiosdk', '3.3.201-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.46-300-dev'
baidu_static.dependency 'jobase/jobase', '1.3.20-165-dev'
baidu_static.dependency 'transengine/transengine-full', '3.3.101-1277-dev'
baidu_static.dependency 'yy264', '1.0.17'
baidu_static.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.3.201-dev'
baidu_static.dependency 'yydec265', '1.0.17'
baidu_static.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.11.101-dev.7'
    ...
    baidu_static.vendored_libraries = 'libs/libthunderbolt.a'
    baidu_static.library = 'thunderbolt'
  end

  s.subspec 'thunderbolt_ai' do |fullai|
    fullai.platform = :ios, '4.3'
    fullai.ios.deployment_target = '4.3'
    fullai.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.3-dev.93'
fullai.dependency 'hydra/lite', '1.3.46-300-dev'
fullai.dependency 'jobase/jobase', '1.3.20-165-dev'
fullai.dependency 'libyuv', '1.0.3-dev.38'
fullai.dependency 'transengine/transengine-full', '3.3.101-1277-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.201-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.46-300-dev'
audio.dependency 'jobase/jobase', '1.3.20-165-dev'
audio.dependency 'transengine/transengine-audio', '3.3.101-1277-dev'
audio.dependency 'yyaudiosdk', '3.3.201-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.46-300-dev'
audioai.dependency 'jobase/jobase', '1.3.20-165-dev'
audioai.dependency 'transengine/transengine-audio', '3.3.101-1277-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.201-dev'
