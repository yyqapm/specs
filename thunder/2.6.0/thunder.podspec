Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.6.0/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.11.1'
...
full.dependency 'transengine/transengine-full', '2.6.1'
full.dependency 'yyservicesdk/yyservicesdk', '2.3.0'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.4.1'
...
audio.dependency 'audioenginesdk', '10.11.1'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.6.1'
