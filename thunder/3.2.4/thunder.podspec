Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.2.4/thunder.zip" }

  s.default_subspec = 'thunderbolt'
  s.subspec 'thunderbolt' do |full|
    full.platform = :ios, '4.3'
    full.ios.deployment_target = '4.3'
    full.dependency 'audioenginesdk', '10.18.1'
...
full.dependency 'transengine/transengine-full', '3.2.1'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.10.4'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'audioenginesdk', '10.18.1'
audio.dependency 'hydra/lite', '1.2.11'
audio.dependency 'jobase/jobase', '1.2.2'
audio.dependency 'transengine/transengine-audio', '3.2.1'
