Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.1.1/thunder.zip" }

  s.default_subspec = 'thunderbolt'
  s.subspec 'thunderbolt' do |full|
    full.platform = :ios, '4.3'
    full.ios.deployment_target = '4.3'
    full.dependency 'audioenginesdk', '10.17.2'
full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.5'
full.dependency 'hydra/lite', '1.1.25'
full.dependency 'jobase/jobase', '1.1.1'
full.dependency 'jolog/jolog-lite', '1.1.70'
full.dependency 'libvpx', '1.0.3'
full.dependency 'libyuv', '1.0.2'
full.dependency 'transengine/transengine-full', '3.1.3'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.9.3'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'audioenginesdk', '10.17.2'
audio.dependency 'hydra/lite', '1.1.25'
audio.dependency 'jobase/jobase', '1.1.1'
audio.dependency 'jolog/jolog-lite', '1.1.70'
audio.dependency 'transengine/transengine-audio', '3.1.3'
