Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.19-579-dev/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '2.4.19'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.13-dev.1'
...
audio.dependency 'transengine/transengine-audio', '2.4.19'
