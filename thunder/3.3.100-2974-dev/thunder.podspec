Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.100-2974-dev/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '3.3.100-1152-dev'
full.dependency 'yyaudiosdk', '3.3.100-dev'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.100-dev.13'
...
fullai.dependency 'transengine/transengine-full', '3.3.100-1152-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.100-dev'
fullai.dependency 'yydec265', '1.0.12'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.100-dev.13'
...
audio.dependency 'transengine/transengine-audio', '3.3.100-1152-dev'
audio.dependency 'yyaudiosdk', '3.3.100-dev'
...
audioai.dependency 'transengine/transengine-audio', '3.3.100-1152-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.100-dev'
