Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.52/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.104'
full.dependency 'dwx265', '2.0.3'
full.dependency 'ffmpeg/ffmpeg-332-ios', '332.500.003'
full.dependency 'gslb', '1.0.11'
full.dependency 'ittiamhevc', '0500.6803.0'
full.dependency 'libyuv', '1194.5004.0'
full.dependency 'transengine/transengine-full', '2.4.51'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.5.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.13'
...
audio.dependency 'audioenginesdk', '10.9.104'
audio.dependency 'gslb', '1.0.11'
audio.dependency 'transengine/transengine-audio', '2.4.51'
