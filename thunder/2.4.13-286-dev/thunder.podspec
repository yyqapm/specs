Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.13-286-dev/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.100'
...
full.dependency 'transengine/transengine-full', '2.4.13-dev.235'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.10-dev.7'
...
audio.dependency 'audioenginesdk', '10.9.100'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.13-dev.235'
