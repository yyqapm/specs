Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.5.5/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.10.5'
...
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.3.4'
...
audio.dependency 'audioenginesdk', '10.10.5'
