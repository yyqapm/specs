Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.3/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '2.4.11'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.3.0'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.2.1'
...
audio.dependency 'transengine/transengine-audio', '2.4.11'
