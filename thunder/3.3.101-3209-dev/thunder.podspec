Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.101-3209-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.44-290-dev'
full.dependency 'jobase/jobase', '1.3.20-156-dev'
full.dependency 'libyuv', '1.0.3-dev.35'
full.dependency 'transengine/transengine-full', '3.3.101-1245-dev'
full.dependency 'yyaudiosdk', '3.3.200-dev'
full.dependency 'yydec265', '1.0.16'
...
full_static.dependency 'libyuv', '1.0.3-dev.35'
full_static.dependency 'transengine/transengine-full', '3.3.101-1245-dev'
full_static.dependency 'yyaudiosdk', '3.3.200-dev'
full_static.dependency 'yydec265', '1.0.16'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.44-290-dev'
baidu_static.dependency 'jobase/jobase', '1.3.20-156-dev'
baidu_static.dependency 'transengine/transengine-full', '3.3.101-1245-dev'
baidu_static.dependency 'yy264', '1.0.15'
baidu_static.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.3.200-dev'
baidu_static.dependency 'yydec265', '1.0.16'
...
fullai.dependency 'hydra/lite', '1.3.44-290-dev'
fullai.dependency 'jobase/jobase', '1.3.20-156-dev'
fullai.dependency 'libyuv', '1.0.3-dev.35'
fullai.dependency 'transengine/transengine-full', '3.3.101-1245-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.200-dev'
fullai.dependency 'yydec265', '1.0.16'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.11.101-dev.7'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.44-290-dev'
audio.dependency 'jobase/jobase', '1.3.20-156-dev'
audio.dependency 'transengine/transengine-audio', '3.3.101-1245-dev'
audio.dependency 'yyaudiosdk', '3.3.200-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.44-290-dev'
audioai.dependency 'jobase/jobase', '1.3.20-156-dev'
audioai.dependency 'transengine/transengine-audio', '3.3.101-1245-dev'
