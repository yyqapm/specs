Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.9.12/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.15.0'
...
full.dependency 'transengine/transengine-full', '2.9.10'
full.dependency 'yyservicesdk/yyservicesdk', '~> 3.3.1'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.7.51'
...
audio.dependency 'audioenginesdk', '10.15.0'
audio.dependency 'gslb', '1.0.12'
audio.dependency 'spidercrab', '~> 1.2.0'
audio.dependency 'transengine/transengine-audio', '2.9.10'
