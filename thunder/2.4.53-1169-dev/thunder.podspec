Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.53-1169-dev/thunder.zip" }
...
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.5.2-dev.0'
