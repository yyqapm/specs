Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.51-637-dev/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '2.4.50'
full.dependency 'yyservicesdk/yyservicesdk', '~> 2.4.0'
...
audio.dependency 'transengine/transengine-audio', '2.4.50'
