Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.5.3/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.10.4'
...
audio.dependency 'audioenginesdk', '10.10.4'
