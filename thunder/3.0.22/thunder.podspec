Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.0.22/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.16.200'
full.dependency 'ffmpeg/ffmpeg-332-ios', '1.0.3'
full.dependency 'hydra/lite', '1.1.23'
full.dependency 'jobase/jobase', '1.0.2'
full.dependency 'jodns/jodns', '1.0.2'
full.dependency 'jolog/jolog-lite', '1.1.3'
full.dependency 'libvpx', '1.0.3'
full.dependency 'libyuv', '1.0.2'
full.dependency 'transengine/transengine-full', '3.0.20'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.8.21'
...
audio.dependency 'audioenginesdk', '10.16.200'
audio.dependency 'hydra/lite', '1.1.23'
audio.dependency 'jobase/jobase', '1.0.2'
audio.dependency 'jodns/jodns', '1.0.2'
audio.dependency 'jolog/jolog-lite', '1.1.3'
audio.dependency 'transengine/transengine-audio', '3.0.20'
