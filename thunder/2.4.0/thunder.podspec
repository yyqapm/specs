Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/thunder/2.4.0/thunder.zip" }
...
full.dependency 'audioenginesdk', '10.9.0'
...
full.dependency 'transengine/transengine-full', '2.4.0'
...
audio.dependency 'audioenginesdk', '10.9.0'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'transengine/transengine-audio', '2.4.0'
