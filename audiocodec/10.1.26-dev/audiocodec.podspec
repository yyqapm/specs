Pod::Spec.new do |s|
	...
	s.source       = {:http => "http://repo.yypm.com/dwbuild/mobile/ios/audiocodec/audiocodec_dependentsdk_maint/20190514-206-r6132d3e72c6003f7836ae10f6b24f74258b3fefa//audiocodec.zip"}
