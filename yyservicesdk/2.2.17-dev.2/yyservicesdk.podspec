Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yyservicesdk/2.2.17-dev.2/yyservicesdk.zip" }
  s.default_subspec = 'yyservicesdk'
  s.subspec 'yyservicesdk' do |sw|
    sw.dependency 'openssl', '111.22.0'
sw.dependency 'yyaccesstranssdk', '1.2.4'
  ...
  s.subspec 'yyservicesdk-dynamic' do |sx|
    sx.dependency 'openssl', '111.22.0'
