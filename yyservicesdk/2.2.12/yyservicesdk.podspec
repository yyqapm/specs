Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yyservicesdk/2.2.12/yyservicesdk.zip" }
  s.default_subspec = 'yyservicesdk'
  s.subspec 'yyservicesdk' do |sw|
    sw.dependency 'openssl', '111.6717.0'
sw.dependency 'yyaccesstranssdk', '1.2.1'
...
sx.dependency 'yyaccesstranssdk', '1.2.1'
