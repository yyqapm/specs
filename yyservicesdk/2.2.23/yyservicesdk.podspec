Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yyservicesdk/2.2.23/yyservicesdk.zip" }
  s.default_subspec = 'yyservicesdk'
  s.subspec 'yyservicesdk' do |sw|
    sw.dependency 'gslbsdki', '1.3.2'
sw.dependency 'openssl', '111.6721.0'
sw.dependency 'yyaccesstranssdk', '1.2.7'
...
sx.dependency 'yyaccesstranssdk', '1.2.7'
