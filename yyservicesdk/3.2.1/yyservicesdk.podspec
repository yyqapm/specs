Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yyservicesdk/3.2.1/yyservicesdk.zip" }
  s.default_subspec = 'yyservicesdk'
  s.subspec 'yyservicesdk' do |sw|
    sw.dependency 'gslb', '1.0.10'
sw.dependency 'openssl', '111.6721.0'
sw.dependency 'yyaccesstranssdk/yyaccesstranssdklib', '1.2.7'
  ...
  s.subspec 'yyservicesdk-dynamic' do |sx|
    sx.dependency 'gslb', '1.0.10'
sx.dependency 'yyaccesstranssdk/yyaccesstranssdklib', '1.2.7'
...
ss.dependency 'yyaccesstranssdk/yyaccesstranssdkmaclib', '1.2.7'
