Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk/7.16.74-dev/yylivesdk.zip" }
...
sw.dependency 'yysignalsdk/yysignalsdkcopy', '1.9.109'
...
sx.dependency 'yysignalsdk/yysignalsdkcopy', '1.9.109'
