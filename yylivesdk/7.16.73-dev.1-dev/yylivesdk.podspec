Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk/7.16.73-dev.1-dev/yylivesdk.zip" }
...
ss.dependency 'yysignalsdk/yysignalsdkcopy', '1.9.106'
...
sw.dependency 'yysignalsdk/yysignalsdkcopy', '1.9.106'
...
sx.dependency 'yysignalsdk/yysignalsdkcopy', '1.9.106'
