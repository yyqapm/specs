Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/MeiPaiSdk/0.14.7-dev/MeiPaiSdk.zip" }
	...
	ss.dependency 'MeiPaiSdk/BaseApiSDK'
	ss.dependency 'MeiPaiSdk/BlockNotification'
	ss.dependency 'MeiPaiSdk/channelProject'
	ss.dependency 'MeiPaiSdk/HWFunctional-YY'
	ss.dependency 'MeiPaiSdk/OpenSSL-YY'
	ss.dependency 'MeiPaiSdk/SwipeView-YY'
	ss.dependency 'MeiPaiSdk/YMLaboratory'
	ss.dependency 'MeiPaiSdk/YYKit-YY'
	ss.dependency 'MeiPaiSdk/YYQueueTaskManager'
	ss.dependency 'MeiPaiSdk/YYUnionAccount'
	ss.dependency 'MeiPaiSdk/athcontext'
	ss.dependency 'MeiPaiSdk/audiocodec'
	ss.dependency 'MeiPaiSdk/audiodsp'
	ss.dependency 'MeiPaiSdk/audioenginesdk'
	ss.dependency 'MeiPaiSdk/avtranssdk'
	ss.dependency 'MeiPaiSdk/deviceinfokit'
	ss.dependency 'MeiPaiSdk/dwx265'
	ss.dependency 'MeiPaiSdk/ffmpeg'
	ss.dependency 'MeiPaiSdk/gslb'
	ss.dependency 'MeiPaiSdk/hdstatsdk'
	ss.dependency 'MeiPaiSdk/ittiamhevc'
	ss.dependency 'MeiPaiSdk/orangefilter'
	ss.dependency 'MeiPaiSdk/udbauthsdk'
	ss.dependency 'MeiPaiSdk/venus'
	ss.dependency 'MeiPaiSdk/y2aplayer'
	ss.dependency 'MeiPaiSdk/yyabtestsdk'
	ss.dependency 'MeiPaiSdk/yyantilib'
	ss.dependency 'MeiPaiSdk/yycloudbs2sdk'
	ss.dependency 'MeiPaiSdk/yylivekit'
	ss.dependency 'MeiPaiSdk/yylivesdk'
	ss.dependency 'MeiPaiSdk/yymtfacedetector'
	ss.dependency 'MeiPaiSdk/yyopentracing'
	ss.dependency 'MeiPaiSdk/yysignalsdk'
	ss.dependency 'MeiPaiSdk/yyvideolib'
	end
	
	
	s.subspec 'BaseApiSDK' do |ss|
	ss.vendored_libraries = 'include/sdks/BaseApiSDK/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/BaseApiSDK/libs/*.framework'
	ss.resource = "include/sdks/BaseApiSDK/resource/*.bundle"
	end
	
	s.subspec 'BlockNotification' do |ss|
	ss.vendored_libraries = 'include/sdks/BlockNotification/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/BlockNotification/libs/*.framework'
	ss.resource = "include/sdks/BlockNotification/resource/*.bundle"
	end
	
	s.subspec 'channelProject' do |ss|
	ss.vendored_libraries = 'include/sdks/ChannelProject/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/ChannelProject/libs/*.framework'
	ss.resource = "include/sdks/ChannelProject/resource/*.bundle",'include/include/*.{storyboard,xib}'
	ss.source_files = 'include/include/*.{h,m}','include/libs/ATHContext.framework/**/*.h'
	end
	
	s.subspec 'HWFunctional-YY' do |ss|
	ss.vendored_libraries = 'include/sdks/HWFunctional-YY/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/HWFunctional-YY/libs/*.framework'
	ss.resource = "include/sdks/HWFunctional-YY/resource/*.bundle"
	end
	
	s.subspec 'OpenSSL-YY' do |ss|
	ss.vendored_libraries = 'include/sdks/OpenSSL-YY/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/OpenSSL-YY/libs/*.framework'
	ss.resource = "include/sdks/OpenSSL-YY/resource/*.bundle"
	end
	
	s.subspec 'SwipeView-YY' do |ss|
	ss.vendored_libraries = 'include/sdks/SwipeView-YY/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/SwipeView-YY/libs/*.framework'
	ss.resource = "include/sdks/SwipeView-YY/resource/*.bundle"
	end
	
	s.subspec 'YMLaboratory' do |ss|
	ss.vendored_libraries = 'include/sdks/YMLaboratory/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/YMLaboratory/libs/*.framework'
	ss.resource = "include/sdks/YMLaboratory/resource/*.bundle"
	end
	
	s.subspec 'YYKit-YY' do |ss|
	ss.vendored_libraries = 'include/sdks/YYKit-YY/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/YYKit-YY/libs/*.framework'
	ss.resource = "include/sdks/YYKit-YY/resource/*.bundle"
	end
	
	s.subspec 'YYQueueTaskManager' do |ss|
	ss.vendored_libraries = 'include/sdks/YYQueueTaskManager/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/YYQueueTaskManager/libs/*.framework'
	ss.resource = "include/sdks/YYQueueTaskManager/resource/*.bundle"
	end
	
	s.subspec 'YYUnionAccount' do |ss|
	ss.vendored_libraries = 'include/sdks/YYUnionAccount/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/YYUnionAccount/libs/*.framework'
	ss.resource = "include/sdks/YYUnionAccount/resource/*.bundle"
	end
	...
	ss.vendored_libraries = 'include/sdks/yyabtestsdk/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/yyabtestsdk/libs/*.framework'
	ss.resource = "include/sdks/yyabtestsdk/resource/*.bundle"
	end
	...
	ss.vendored_libraries = 'include/sdks/yymtfacedetector/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/yymtfacedetector/libs/*.framework'
	ss.resource = "include/sdks/yymtfacedetector/resource/*.bundle"
	end
	
	s.subspec 'yyopentracing' do |ss|
	ss.vendored_libraries = 'include/sdks/yyopentracing/libs/*.a'
	ss.vendored_frameworks = 'include/sdks/yyopentracing/libs/*.framework'
	ss.resource = "include/sdks/yyopentracing/resource/*.bundle"
	end
