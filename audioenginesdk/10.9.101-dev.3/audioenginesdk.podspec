Pod::Spec.new do |s|
	...
	s.source       = {:http => "http://cirepo.bs2dl.yy.com/sdks/ios/audioenginesdk/10.9.101-dev.3/audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiocodec', '10.1.43000-dev.1'
