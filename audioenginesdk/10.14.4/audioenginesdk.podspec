Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/audioenginesdk/10.14.4/audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiocodec', '10.1.48'
ss.dependency 'audiodsp', '1.3.0'
	...
	s.subspec 'audioenginesdk_mac' do |ssm|
		ssm.dependency 'audiocodec/audiocodec_mac', '10.1.48'
ssm.dependency 'audiodsp/audiodsp_mac', '1.3.0'
