Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/audioenginesdk/10.16.102/audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiocodec', '10.1.54'
ss.dependency 'audiodsp', '1.3.3'
	...
	s.subspec 'audioenginesdk_mac' do |ssm|
		ssm.dependency 'audiocodec/audiocodec_mac', '10.1.54'
ssm.dependency 'audiodsp/audiodsp_mac', '1.3.3'
