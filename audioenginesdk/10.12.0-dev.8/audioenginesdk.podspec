Pod::Spec.new do |s|
	...
	s.source       = {:http => "http://cirepo.bs2dl.yy.com/sdks/ios/audioenginesdk/10.12.0-dev.8/audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiocodec', '10.1.45'
