Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/audioenginesdk/10.18.1/audioenginesdk.zip"}
	
	s.default_subspec = 'audioenginesdk'
	s.subspec 'audioenginesdk' do |ss|
		ss.dependency 'audiodsp', '1.3.4'
ss.dependency 'yyaudiocodec', '1.0.3'
...
ssm.dependency 'yyaudiocodec_mac', '1.0.3'
