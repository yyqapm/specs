Pod::Spec.new do |s|
	...
	s.version      = '0.0.2'
	s.summary      = 'sdk demo'
	s.homepage     = 'https://git.yy.com/apps/ci/oneswitchSDK-ios.git'
	s.author       = { 'yy' => 'jiangrenjie@yy.com' }
	s.source       = { :http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/oneswitchSDK/0.0.2/oneswitchSDK.zip" }
