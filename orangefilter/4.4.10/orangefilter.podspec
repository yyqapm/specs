Pod::Spec.new do |s|
        ...
        s.source                = {:http =>"https://cirepo.bs2dl.yy.com/sdks/ios/orangefilter/4.4.10/orangefilter.zip"}
        ...
        s.subspec 'orangefilter_static-meipai-core' do |ssmc|
                ...
                ssmc.libraries = 'of_core_static', 'png_static', 'zlib_static', 'opencv_static', 'of_effect_static', 'of_pose_static', 'lua'
