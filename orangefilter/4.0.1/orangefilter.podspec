Pod::Spec.new do |s|
        ...
        s.source                = {:http =>"http://cirepo.bs2dl.yy.com/sdks/ios/orangefilter/4.0.1/orangefilter.zip"}
        ...
        s.subspec 'orangefilter-all_no_ar' do |sdan|
                ...
                sdan.ios.vendored_frameworks = 'libs/zlib.framework', 'libs/libpng.framework', 'libs/opencv.framework', 'libs/of_effect.framework', 'libs/of_pose.framework', 'libs/of_core.framework', 'libs/facedancegame.framework', 'libs/ardancegame.framework'
        end
        ...
        s.subspec 'orangefilter_static-core' do |ssc|
                ...
                ssc.libraries = 'of_core_static', 'png_static', 'zlib_static', 'opencv_static', 'of_effect_static', 'of_pose_static', 'bullet', 'lua','vpx', 'webp', 'freetype'
                ssc.ios.vendored_libraries = 'libs/libof_core_static.a', 'libs/libpng_static.a', 'libs/libzlib_static.a', 'libs/libopencv_static.a', 'libs/libof_effect_static.a', 'libs/libof_pose_static.a', 'libs/libbullet.a', 'libs/liblua.a', 'libs/libvpx.a', 'libs/libwebp.a', 'libs/libfreetype.a'
        end
