Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yysignalsdk/1.9.106/yysignalsdk.zip" }
	
	s.default_subspec = 'yysignalsdk'
	
	s.subspec 'yysignalsdk' do |sw|
        sw.dependency 'yyantilib/yyantilibstd', '2.1.17'
	...
	s.subspec 'signalsdk' do |sx|
        sx.dependency 'yyantilib/yyantilibstd', '2.1.17'
