Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyunionsdk/0.28.957-dev/yyunionsdk.zip" }
...
ss.dependency 'yyvideolib/yyvideolibstatic', '3.8.55'
    ...
    ss.vendored_libraries = 'libs/libCocoaLumberjack.a'
