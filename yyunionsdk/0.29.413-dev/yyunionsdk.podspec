Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyunionsdk/0.29.413-dev/yyunionsdk.zip" }
...
ss.dependency 'yylivesdk/yylivesdkmeipa', '7.16.74-dev'
