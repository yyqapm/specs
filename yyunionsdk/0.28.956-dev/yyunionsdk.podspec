Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyunionsdk/0.28.956-dev/yyunionsdk.zip" }
...
ss.dependency 'yyvideolib/yyvideolibstatic', '3.8.55'
    ...
    ss.dependency 'yyunionsdk/CocoaLumberjack'
    ...
    ss.vendored_libraries = 'libs/CocoaLumberjack.a'
    ss.resource = "include/sdks/CocoaLumberjack/resource/*.bundle"
    end
    
    s.subspec 'yyunioncomponentkit' do |ss|
    ss.vendored_libraries = 'libs/yyunioncomponentkit.a'
    ss.resource = "include/sdks/yyunioncomponentkit/resource/*.bundle"
    end
    
    s.subspec 'YYUnionRoute' do |ss|
    ss.vendored_libraries = 'libs/YYUnionRoute.a'
