Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyunionsdk/0.28.302-dev/yyunionsdk.zip" }
	...
	s.dependency 'athcontext', '1.2.7'
	s.dependency 'yylivesdk/yylivesdkmeipa', '7.16.73-dev.4'
	s.dependency 'hdstatsdk', '3.2.47'
	s.dependency 'audiocodec', '10.1.250101'
	s.dependency 'audiodsp', '1.2.8'
	s.dependency 'yycloudbs2sdk', '1.4.3'
	s.dependency 'gslb', '2.1.5'
	...
	ss.source_files = 'include/include/*.{h,m}'
	end
