Pod::Spec.new do |s|
	...
	s.platform     = :ios, "9.0"
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyunionsdk/0.27.413-dev/yyunionsdk.zip" }
	...
	ss.dependency 'ffmpeg', '~> 332170717.6519.0'
	ss.dependency 'gslb', '~> 2.1.5'
	ss.dependency 'hdstatsdk', '~> 3.2.47'
	ss.dependency 'ittiamhevc', '~> 0500.6803.0'
	ss.dependency 'orangefilter', '~> 4.4.10'
	ss.dependency 'udbauthsdk', '~> 3.11.8'
	ss.dependency 'yyantilib', '~> 2.2.8'
	ss.dependency 'yysignalsdk', '~> 1.9.106'
	ss.dependency 'yymobileopentracing', '~> 0.0.1'
	ss.dependency 'yyvideolib', '~> 3.8.55'
	ss.dependency 'yylivesdk'
