Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/jolog/1.1.2/jolog.zip" }
  ...
  s.subspec 'jolog-full' do |full|
    ...
    full.dependency 'hydra/hydra', '1.1.7'
full.dependency 'jobase/jobase', '1.0.1'
  ...
  s.subspec 'jolog-full-macOS' do |full_mac|
    ...
    full_mac.dependency 'hydra/hydra_macOS', '1.1.7'
full_mac.dependency 'jobase/jobase-mac', '1.0.1'
  ...
  s.subspec 'jolog-lite' do |lite|
    ...
    lite.dependency 'hydra/lite', '1.1.7'
lite.dependency 'jobase/jobase', '1.0.1'
  ...
  s.subspec 'jolog-lite-macOS' do |lite_mac|
    ...
    lite_mac.dependency 'hydra/lite_macOS', '1.1.7'
