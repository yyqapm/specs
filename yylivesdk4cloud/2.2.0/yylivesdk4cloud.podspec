Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.2.0/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.7.4'
full.dependency 'avtranssdk', '1.7.61'
...
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.0.0'
...
audio.dependency 'audioenginesdk', '10.7.4'
audio.dependency 'avtranssdk', '1.7.61'
