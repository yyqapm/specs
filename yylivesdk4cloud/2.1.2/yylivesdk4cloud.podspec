Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.1.2/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.63'
...
audio.dependency 'avtranssdk', '1.7.63'
