Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.8.5/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.69'
...
audio.dependency 'avtranssdk', '1.7.69'
