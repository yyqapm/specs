Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.3.1/yylivesdk4cloud.zip" }
...
full.dependency 'yyservicesdk/yyservicesdk', '2.2.16'
...
dy.dependency 'yyservicesdk/yyservicesdk', '2.2.16'
