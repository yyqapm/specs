Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.3.10/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.104'
...
full.dependency 'openssl', '111.6721.0'
full.dependency 'yyservicesdk/yyservicesdk', '2.2.22'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.1.6'
...
audio.dependency 'avtranssdk', '1.7.104'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'openssl', '111.6721.0'
