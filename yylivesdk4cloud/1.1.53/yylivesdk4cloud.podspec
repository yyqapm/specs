Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://repo.yypm.com/dwbuild/mobile/ios/yylivesdk4cloud/YYLIVESDK4CLOUD_1.1.53_REL/20190429-1112-re759bc7d0e3965fc5e9cdcac7577912c1f36f701//yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.3.8'
full.dependency 'avtranssdk', '1.7.27'
...
full.dependency 'orangefilter/orangefilter_static-all_no_ar', '4.1.5'
full.dependency 'stmobile', '1.4.2'
full.dependency 'yyvideolib/yyvideolibstatic', '3.9.98'
...
audio.dependency 'audioenginesdk', '10.3.8'
audio.dependency 'avtranssdk', '1.7.27'
