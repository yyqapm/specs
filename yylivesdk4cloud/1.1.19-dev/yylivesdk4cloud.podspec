Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://repo.yypm.com/dwbuild/mobile/ios/yylivesdk4cloud/yylivesdk4cloud-ios_1.1_maint/20180830-404-r2248522//yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '2.7.938'
...
full.dependency 'orangefilter', '3.5.3'
full.dependency 'stmobile', '1.4.0'
full.dependency 'transsdk', '99.99.14-dev.23'
full.dependency 'yyvideolib/yyvideolibstatic', '3.1.1'
	...
	s.subspec 'yylivesdk4cloud-audio' do |audio|
		...
		audio.dependency 'audioenginesdk', '2.7.938'
