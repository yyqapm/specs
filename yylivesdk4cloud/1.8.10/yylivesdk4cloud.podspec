Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.8.10/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.6.100'
...
audio.dependency 'audioenginesdk', '10.6.100'
