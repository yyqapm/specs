Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.8.0-dev8/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.4.2-dev'
full.dependency 'avtranssdk', '99.04.39-dev'
...
audio.dependency 'audioenginesdk', '10.4.2-dev'
audio.dependency 'avtranssdk', '99.04.39-dev'
