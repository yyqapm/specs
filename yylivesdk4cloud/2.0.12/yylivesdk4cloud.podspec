Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.0.12/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.5.1'
full.dependency 'avtranssdk', '1.7.18'
...
full.dependency 'yyvideolib/yyvideolibstatic', '3.9.52'
...
audio.dependency 'audioenginesdk', '10.5.1'
audio.dependency 'avtranssdk', '1.7.18'
