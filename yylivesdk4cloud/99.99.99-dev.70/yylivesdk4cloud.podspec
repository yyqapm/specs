Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://raw.githubusercontent.com/yyqapm/blobs/master/yylivesdk4cloud/99.99.99-dev.70/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.5.1-dev'
full.dependency 'avtranssdk', '1.7.18-dev.7'
full.dependency 'dwx265', '2.0.3'
full.dependency 'ffmpeg/ffmpeg-332-ios', '332170717.6519.0'
full.dependency 'gslbsdki', '1.3.1'
full.dependency 'hdstatsdk/HiidoSDKDynamic', '3.2.32'
full.dependency 'ittiamhevc', '0500.6803.0'
full.dependency 'libyuv', '1194.5004.0'
full.dependency 'openssl', '111.6717.0'
full.dependency 'orangefilter/orangefilter_static-all_no_ar', '4.1.0-dev'
full.dependency 'stmobile', '1.4.2'
full.dependency 'yyservicesdk/yyservicesdk', '2.2.0-dev.3'
full.dependency 'yyvideolib/yyvideolibstatic', '3.9.0-dev.40'
	...
	s.subspec 'yylivesdk4clouddynamic' do |dy|
		...
		dy.dependency 'ffmpeg/ffmpeg-332-ios', '332170717.6519.0'
dy.dependency 'hdstatsdk/HiidoSDKDynamic', '3.2.32'
dy.dependency 'stmobile', '1.4.2'
dy.dependency 'yyservicesdk/yyservicesdk', '2.2.0-dev.3'
...
audio.dependency 'audioenginesdk', '10.5.1-dev'
audio.dependency 'avtranssdk', '1.7.18-dev.7'
audio.dependency 'gslbsdki', '1.3.1'
