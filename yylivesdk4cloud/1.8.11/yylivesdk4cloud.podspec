Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.8.11/yylivesdk4cloud.zip" }
	
	s.default_subspec = 'yylivesdk4cloud'
	s.subspec 'yylivesdk4cloud' do |full|
		full.platform = :ios, '4.3'
		full.ios.deployment_target = '4.3'
		full.dependency 'argo', '2.0.1'
full.dependency 'audioenginesdk', '10.6.101'
full.dependency 'avtranssdk', '1.7.110'
...
full.dependency 'orangefilter/orangefilter_static-all_no_ar', '4.0.1'
full.dependency 'stmobile', '1.4.2'
full.dependency 'yyvideolib/yyvideolibstatic', '3.5.4'
	...
	s.subspec 'yylivesdk4clouddynamic' do |dy|
		...
		dy.dependency 'ffmpegframework/ffmpegframework', '1.0.2'
dy.dependency 'stmobile', '1.4.2'
	...
	s.subspec 'yylivesdk4cloud-audio' do |audio|
		...
		audio.dependency 'argo', '2.0.1'
audio.dependency 'audioenginesdk', '10.6.101'
audio.dependency 'avtranssdk', '1.7.110'
