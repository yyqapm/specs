Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://repo.yypm.com/dwbuild/mobile/ios/yylivesdk4cloud/YYLIVESDK4CLOUD_1.7.2_REL/20190411-1049-r2406724//yylivesdk4cloud.zip" }
...
full.dependency 'transsdk', '1.6.96'
...
audio.dependency 'transsdk', '1.6.96'
