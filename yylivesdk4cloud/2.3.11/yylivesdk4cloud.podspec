Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.3.11/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.161'
...
full.dependency 'yyservicesdk/yyservicesdk', '2.2.23'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.1.6'
	...
	s.subspec 'yylivesdk4clouddynamic' do |dy|
		...
		dy.dependency 'yyaccesstranssdk', '1.2.7'
...
audio.dependency 'avtranssdk', '1.7.161'
