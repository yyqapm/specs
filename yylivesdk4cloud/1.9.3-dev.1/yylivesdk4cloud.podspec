Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.9.3-dev.1/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.4.9'
...
full.dependency 'transengine', '1.0.2-dev.76'
full.dependency 'yyvideolib/yyvideolibstatic', '3.9.97'
...
audio.dependency 'audioenginesdk', '10.4.9'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'openssl', '111.6717.0'
audio.dependency 'transengine', '1.0.2-dev.76'
