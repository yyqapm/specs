Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.2.1/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.7.6'
...
audio.dependency 'audioenginesdk', '10.7.6'
