Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.2.2/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.7.7'
full.dependency 'avtranssdk', '1.7.85'
...
full.dependency 'yyservicesdk/yyservicesdk', '2.2.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.0.1'
...
dy.dependency 'yyservicesdk/yyservicesdk', '2.2.12'
...
audio.dependency 'audioenginesdk', '10.7.7'
audio.dependency 'avtranssdk', '1.7.85'
