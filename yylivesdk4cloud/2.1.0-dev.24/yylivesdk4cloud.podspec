Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.1.0-dev.24/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.6.0'
full.dependency 'avtranssdk', '1.7.53'
...
full.dependency 'yyvideolib/yyvideolibstatic', '3.9.51'
...
dy.dependency 'yyservicesdk/yyservicesdk', '2.2.2'
	...
	s.subspec 'yylivesdk4clouddynamicaudio' do |ydaudio|
		...
		ydaudio.requires_arc = true
                ...
                ydaudio.frameworks = 'VideoToolbox'
...
audio.dependency 'audioenginesdk', '10.6.0'
audio.dependency 'avtranssdk', '1.7.53'
