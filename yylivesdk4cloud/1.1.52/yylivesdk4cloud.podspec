Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.1.52/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.1.21'
...
full.dependency 'transsdk', '1.7.05'
full.dependency 'yyvideolib/yyvideolibstatic', '3.5.6'
...
audio.dependency 'audioenginesdk', '10.1.21'
audio.dependency 'openssl', '111.6717.0'
audio.dependency 'transsdk', '1.7.05'
