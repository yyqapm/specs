Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.3.0-dev.39993/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.100-dev0'
...
audio.dependency 'avtranssdk', '1.7.100-dev0'
