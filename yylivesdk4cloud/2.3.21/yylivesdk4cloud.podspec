Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/2.3.21/yylivesdk4cloud.zip" }
...
full.dependency 'audioenginesdk', '10.8.1'
full.dependency 'avtranssdk', '1.7.105'
...
full.dependency 'openssl', '111.6720.0'
full.dependency 'yyservicesdk/yyservicesdk', '2.2.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.1.3'
...
dy.dependency 'yyaccesstranssdk', '1.2.4'
...
audio.dependency 'audioenginesdk', '10.8.1'
audio.dependency 'avtranssdk', '1.7.105'
audio.dependency 'gslbsdki', '1.3.2'
audio.dependency 'openssl', '111.6720.0'
