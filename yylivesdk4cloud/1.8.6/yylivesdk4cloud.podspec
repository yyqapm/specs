Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.8.6/yylivesdk4cloud.zip" }
...
full.dependency 'avtranssdk', '1.7.72'
...
audio.dependency 'avtranssdk', '1.7.72'
