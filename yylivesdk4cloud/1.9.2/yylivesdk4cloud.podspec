Pod::Spec.new do |s|
	...
	s.source       = { :http => "http://cirepo.bs2dl.yy.com/sdks/ios/yylivesdk4cloud/1.9.2/yylivesdk4cloud.zip" }
...
full.dependency 'transengine', '1.0.1'
...
audio.dependency 'transengine', '1.0.1'
