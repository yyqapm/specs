Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thundermac/3.1.0/thundermac.zip" }
  ...
  s.subspec 'thunderboltmac' do |full|
    ...
    full.dependency 'audioenginesdk/audioenginesdk_mac', '10.17.0'
full.dependency 'hydra/lite_macOS', '1.1.24'
full.dependency 'jobase/jobase-mac', '1.1.0'
full.dependency 'jolog/jolog-lite-macOS', '1.1.6'
full.dependency 'transengine/transengine-full-macOS', '3.1.0'
full.dependency 'yyvideolibmac', '1.0.27'
  ...
  s.subspec 'thunderboltyymac' do |fullyy|
    ...
    fullyy.dependency 'audioenginesdk/audioenginesdk_mac', '10.17.0'
fullyy.dependency 'hydra/lite_macOS', '1.1.24'
fullyy.dependency 'jobase/jobase-mac', '1.1.0'
fullyy.dependency 'jolog/jolog-lite-macOS', '1.1.6'
fullyy.dependency 'transengine/transengine-full-macOS', '3.1.0'
fullyy.dependency 'yyvideolibmac', '1.0.27'
