Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thundermac/3.0.22/thundermac.zip" }
...
full.dependency 'hydra/lite_macOS', '1.1.26'
full.dependency 'jobase/jobase-mac', '1.0.2'
full.dependency 'jodns/jodns-mac', '1.0.6'
full.dependency 'jolog/jolog-lite-macOS', '1.1.31'
...
fullyy.dependency 'hydra/lite_macOS', '1.1.26'
fullyy.dependency 'jobase/jobase-mac', '1.0.2'
fullyy.dependency 'jodns/jodns-mac', '1.0.6'
fullyy.dependency 'jolog/jolog-lite-macOS', '1.1.31'
