Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thundermac/2.9.10/thundermac.zip" }
...
full.dependency 'audioenginesdk/audioenginesdk_mac', '10.15.0'
full.dependency 'gslbmac', '1.0.0'
full.dependency 'spidercrab/spidercrab_macOS', '~> 1.2.0'
full.dependency 'transengine/transengine-full-macOS', '2.9.10'
